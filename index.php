        ...
        <div class="kasir_left">
            ...
            <div class="produk_lists">
                ...
                <div class="produk_list">
                    <img width="100%" src="https://c.alfagift.id/product/1/1_A7549710001037_20230105135328250_base.png"
                        alt="">
                    ...
                    <table border="1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a onclick="return confirm('Apakah anda yakin ingin menghapus dari cart?');"
                                        href="logic/delete_item_from_cart.php?id=<?= $value['id'] ?>">❌</a></td>
                            </tr>
